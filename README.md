...
| Project | Description | Stack |
| --- | --- | --- |
| [Node.js UTF-8 fast paths](https://github.com/nodejs/node/pull/65131) | Open draft contribution adding UTF-8 aliases to fs fast paths with regression tests and benchmarks. | C++, Node.js internals |
